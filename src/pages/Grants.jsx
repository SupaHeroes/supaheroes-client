...
import { Row, Divider, InputNumber } from 'antd';
...
const Grants = () => {
	...
	const match = (index) => {
		...
		const matchAmt = (
			((contributionArray[index] / goalArray[index]) *
				useGrantAmount *
	...
	return (
		<div className='bg-supadark-black'>
			<div
				style={{ maxWidth: '70%' }}
				className='pt-32 mx-auto  flex min-h-screen flex-col'
			>
				...
				<div className='w-4/5 mx-auto pt-10'>
					...
					<h1 className='text-gray-300 font-light'>
						...
						<a href='https://twitter.com/SupaheroesFund'>Twitter!</a>
					</h1>
					<Divider />
					<Row gutter={16}>
						{goalArray.map((e, i) => (
